...
class LivroAdmin(admin.ModelAdmin):
    ...
    list_display = 'id', 'nome', 'genero', 'escritor', 'editora', 'data_pub', 'disponivel',
...
class ClienteAdmin(admin.ModelAdmin):
    list_display = 'id', 'nome_completo', 'cpf', 'nascimento', 'telefone', 'email',
    ordering = '-id',
...
class Cliente_LivroAdmin(admin.ModelAdmin):
    list_display = 'id', 'id_livro', 'id_cliente', 'data_aluguel', 'data_dev',
    ordering = '-id',
